...
ADMINS = (
    ('Puppet Labs', 'mike@puppetlabs.com'),
)
...
SERVER_EMAIL = 'ask@puppetlabs.com'
DEFAULT_FROM_EMAIL = 'ask@puppetlabs.com'
EMAIL_HOST_USER = 'ask@puppetlabs.com'
EMAIL_HOST_PASSWORD = 'XvQKPbDo '
EMAIL_SUBJECT_PREFIX = 'Puppet Labs Askbot'
...
#ASKBOT_FILE_UPLOAD_DIR = '/var/lib/askbot/upfiles/ask'
